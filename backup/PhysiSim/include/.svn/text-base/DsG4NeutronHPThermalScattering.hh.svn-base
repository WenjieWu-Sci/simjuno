...
// ********************************************************************
//
#ifndef DsG4NeutronHPThermalScattering_h
#define DsG4NeutronHPThermalScattering_h 1
...
class DsG4NeutronHPThermalScattering : public G4HadronicInteraction
{
   public: 
  
      DsG4NeutronHPThermalScattering();
   ...
   private:
      ...
      DsG4NeutronHPThermalScatteringData* theXSection;
      G4double * xSec;
      G4String dirName;
      G4int numEle;
