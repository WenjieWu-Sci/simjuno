...
// ********************************************************************
//
#ifndef DsG4RadioactiveDecay_h
#define DsG4RadioactiveDecay_h 1
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
//
// MODULE:              DsG4RadioactiveDecay.hh
//
// Version:             0.b.4
// Date:                14/04/00
...
////////////////////////////////////////////////////////////////////////////////
//
class DsG4RadioactiveDecaymessenger;
...
class DsG4RadioactiveDecay : public G4VRestDiscreteProcess 
{
  // class description
...
public: // with description
  ...
  DsG4RadioactiveDecay (const G4String& processName="RadioactiveDecay");
  ~DsG4RadioactiveDecay();
  ...
  //  the DsG4RadioactiveDecay applies.
  //
  ...
  //   Controls whether DsG4RadioactiveDecay runs in analogue mode or
  //   variance reduction mode.
  inline void SetFBeta (G4bool r ) { FBeta  = r; }
  //   Controls whether DsG4RadioactiveDecay uses fast beta simulation mode
  //
...
//========================= Begin dayabay ===================================
  G4DecayProducts* DoHe8Decay(G4ParticleDefinition& theParticleDef);
  G4DecayProducts* DoLi9Decay(G4ParticleDefinition& theParticleDef);
//========================= End dayabay   ===================================
...
private:
  ...
  DsG4RadioactiveDecay(const DsG4RadioactiveDecay &right);
  DsG4RadioactiveDecay & operator=(const DsG4RadioactiveDecay &right);

private:

  DsG4RadioactiveDecaymessenger  *theRadioactiveDecaymessenger;
