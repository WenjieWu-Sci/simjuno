...
// ********************************************************************
//
#ifndef DsG4RadioactiveDecaymessenger_h
#define DsG4RadioactiveDecaymessenger_h 1
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
//
...
class DsG4RadioactiveDecay;
////////////////////////////////////////////////////////////////////////////////
//
class DsG4RadioactiveDecaymessenger: public G4UImessenger
{
  // class description
  // The DsG4RadioactiveDecaymessenger is instantiated by the DsG4RadioactiveDecay
  // process and introduces into the UI menu commands to control the running
  // of DsG4RadioactiveDecay

public: //with description
    DsG4RadioactiveDecaymessenger (DsG4RadioactiveDecay*
      theRadioactiveDecayContainer);
  //    Constructor introduces commands into the UI menu to control
  //    DsG4RadioactiveDecay.  theRadioactiveDecayContainer1 is used to identify
  //    to this class (when instatiated) the associated DsG4RadioactiveDecay
  //    process whose parameters are going to be changed as a result
  //    of the UI commands.
  ~DsG4RadioactiveDecaymessenger ();
  ...
  //    these values with the appropriate member function of DsG4RadioactiveDecay.
  //
 private:
  DsG4RadioactiveDecay             *theRadioactiveDecayContainer;
