...
// ********************************************************************
//
// $Id: DsG4MuNuclearInteraction.cc,v 1.11.2.1 2009/03/03 13:34:24 gcosmo Exp $
...
// static members ........
G4int DsG4MuNuclearInteraction::nzdat =  5 ;
G4double DsG4MuNuclearInteraction::zdat[]={1.,4.,13.,29.,92.};
G4double DsG4MuNuclearInteraction::adat[]={1.01,9.01,26.98,63.55,238.03};
G4int DsG4MuNuclearInteraction::ntdat = 8 ;
G4double DsG4MuNuclearInteraction::tdat[]={1.e3,1.e4,1.e5,1.e6,1.e7,1.e8,
                                                             1.e9,1.e10};
G4int DsG4MuNuclearInteraction::NBIN = 1000 ;  
G4double DsG4MuNuclearInteraction::ya[1001]={0.};
G4double DsG4MuNuclearInteraction::proba[5][8][1001]={{{0.}}};
 
DsG4MuNuclearInteraction::DsG4MuNuclearInteraction(const G4String& processName, G4double scaledfactor)
...
DsG4MuNuclearInteraction::~DsG4MuNuclearInteraction()
{
...
void DsG4MuNuclearInteraction::SetPhysicsTableBining(G4double lowE,
						   G4double highE, G4int nBins)
{
  LowestKineticEnergy = lowE; HighestKineticEnergy = highE ; TotBin = nBins ;
}

void DsG4MuNuclearInteraction::PreparePhysicsTable(
...
void DsG4MuNuclearInteraction::BuildPhysicsTable(
                                    const G4ParticleDefinition& aParticleType)
{
...
void DsG4MuNuclearInteraction::ComputePartialSumSigma(
...
G4double DsG4MuNuclearInteraction::ComputeMicroscopicCrossSection(
                                const G4ParticleDefinition* ParticleType,
                                G4double KineticEnergy,
...
G4double DsG4MuNuclearInteraction::ComputeDMicroscopicCrossSection(
                                 const G4ParticleDefinition* ParticleType,
                                 G4double KineticEnergy,
...
void DsG4MuNuclearInteraction::MakeSamplingTables(
                                     const G4ParticleDefinition* ParticleType)
{
...
G4VParticleChange* DsG4MuNuclearInteraction::PostStepDoIt(
...
G4Element* DsG4MuNuclearInteraction::SelectRandomAtom(G4Material* aMaterial) const
{
  ...
  G4cout << "DsG4MuNuclearInteraction WARNING !!! no element selected for '"
	 << aMaterial->GetName()
	 << " 1st element returned." << G4endl;
  return ((*theElementVector)[0]);
}

void DsG4MuNuclearInteraction::PrintInfoDefinition()
{
